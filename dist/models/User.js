...
var User = /** @class */ (function () {
    ...
    User.prototype.createUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userExists()];
                    case 1:
                        _a.sent();
                        if (this.errors.length > 0)
                            return [2 /*return*/];
                        salt = bcryptjs_1.default.genSaltSync();
                        password = bcryptjs_1.default.hashSync(this.user.password, salt);
                        this.user.password = password;
                        return [4 /*yield*/, exports.UserModel.create(this.user)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    User.prototype.auth = function () {
        return __awaiter(this, void 0, void 0, function () {
            var user, isThePasswordValid, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, exports.UserModel.findOne({ email: this.user.email })];
                    case 1:
                        ...
                        isThePasswordValid = bcryptjs_1.default.compareSync(this.user.password, user.password);
