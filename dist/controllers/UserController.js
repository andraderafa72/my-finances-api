...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, schema, error_1, userModel;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        userModel = new User_1.User({ name: name, email: email, password: password });
                        return [4 /*yield*/, userModel.createUser()];
                    case 5:
                        _b.sent();
                        if (userModel.errors.length > 0) {
                            return [2 /*return*/, response.status(400).json(HandleError_1.HandleError(userModel.errors))];
                        }
                        return [2 /*return*/, response.json({ status: 'Created Successfully!', user: userModel.user })];
                }
            });
        });
    };
